...
def checkout(request):
  ...
  if not stripe_public_key:
    messages.warning(request, 'No Public Key detected, please ensure it is set!')
...
def checkout_success(request, order_number):
  """
  Confirms checkout successful to the user
  """
