...
const commentForm = document.getElementById("testimonialForm");
...
for (let button of editButtons) {
  button.addEventListener("click", (e) => {
    let commentId = e.target.getAttribute("data-testimonial_id");
    let commentContent = document.getElementById(`testimonial${testimonialId}`).innerText;
